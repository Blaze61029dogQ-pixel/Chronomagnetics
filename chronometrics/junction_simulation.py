...
- Either M(u) exhibits periodicity in log-time with ω ≈ 2π/ln(λ), OR
...
R = 100.0    # Ω (100 Ω shunt resistance)
I_c = 10.0e-6  # A (10 μA critical current)
I_k = 1.0e-6   # A (1 μA coupling current, weak)
...
# In full theory, this would be derived from teleparallel contortion
...
# Prescribed κ_cm with log-periodic modulation
